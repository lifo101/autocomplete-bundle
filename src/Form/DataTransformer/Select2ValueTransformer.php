...
class Select2ValueTransformer implements DataTransformerInterface
{
    ...
    public function transform($value)
    {
        ...
        try {
            ...
            } elseif ($this->em && $this->em->contains($value)) {
                $id = current($this->em->getUnitOfWork()->getEntityIdentifier($value));
            } else {
                throw new Exception('Unable to determine unique ID for entity. Did you set the "property" field correctly?');
            }
